...
<div class="row row_product" style="text-align: center;">
    ...
    $_SESSION['pr7onowbuy'][] =  $_GET['idbuynow'];

    $drezr = $_SESSION['pr7onowbuy'][0];
if (isset($_GET['idbuynow']) ) {
...
if (isset($_GET['doneOrder'])) {
    ...
    if (mail($to_email, $subject, $body, $headers)) {
        ...
        $order_id, $drezr, $quantity);";
        
        mysqli_query($conn,$sql_insert_details);
        
        // echo '<script>localStorage.clear()</script>';
        unset($_SESSION['pr7onowbuy']);
        ob_start();
